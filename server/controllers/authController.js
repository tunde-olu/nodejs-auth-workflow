...
const verifyEmail = async (req, res) => {
	...
	if (!verificationToken || !email) {
		throw new CustomError.BadRequestError('Please provide both verificationToken and email');
	}
	...
	if (user.verificationToken !== verificationToken) {
		throw new CustomError.BadRequestError('Incorrect verification token');
	}
...
const login = async (req, res) => {
	...
	if (!user) {
		throw new CustomError.UnauthenticatedError(`No account found with ${email}`);
	}
